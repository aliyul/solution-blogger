document.addEventListener("DOMContentLoaded", function() {
  ...
  let updateRekomendasi = typeKonten === "evergreen" ? "update setiap 12 bulan" : "update setiap 3 bulan";
  ...
  typeEl.textContent = `Ini typeKonten: ${typeKonten}, harus ${updateRekomendasi}`;
